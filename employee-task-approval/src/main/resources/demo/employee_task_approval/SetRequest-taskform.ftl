<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("task_price");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid task_price");
							myInputs[j].focus();
							return false;
						}
	...
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[emp]]></div>
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">task_price</label>
                            		<div class="div_texbox">
                              		<input name="task_price" type="text" class="textbox" id="task_price" value="${task_price}" />
                            		</div>
